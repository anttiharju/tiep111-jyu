 ...
 * @version 2020.03.28 15:42:58 // Generated by ComTest
 *
 */
...
public class KirjailijatTest {
  ...
  /** testIterator203 */
  @Test
  public void testIterator203() {    // Kirjailijat: 203
    Kirjailijat kirjailijat = new Kirjailijat(); 
    ...
    assertEquals("From: Kirjailijat line: 215", p12, i2.next()); 
    assertEquals("From: Kirjailijat line: 216", p21, i2.next()); 
    assertEquals("From: Kirjailijat line: 217", p32, i2.next()); 
    assertEquals("From: Kirjailijat line: 218", p41, i2.next()); 
    assertEquals("From: Kirjailijat line: 219", p52, i2.next()); 
    try {
    assertEquals("From: Kirjailijat line: 220", p21, i2.next()); 
    fail("Kirjailijat: 220 Did not throw NoSuchElementException");
    } catch(NoSuchElementException _e_){ _e_.getMessage(); }
    int n = 0; 
    int kidt[] = { 2,1,2,1,2} ; 
    for ( Kirjailija kir : kirjailijat ) {
    assertEquals("From: Kirjailijat line: 226", kidt[n], kir.getId()); n++; 
    }
    assertEquals("From: Kirjailijat line: 229", 5, n); 
  } // Generated by ComTest END


  // Generated by ComTest BEGIN
  /** testAnnaKirjailija243 */
  @Test
  public void testAnnaKirjailija243() {    // Kirjailijat: 243
    Kirjailijat kirjailijat = new Kirjailijat(); 
    ...
    assertEquals("From: Kirjailijat line: 257", true, etsitty == pete); 
    etsitty = kirjailijat.annaKirjailija(1); 
    assertEquals("From: Kirjailijat line: 259", true, etsitty == vesa); 
    etsitty = kirjailijat.annaKirjailija(2); 
    assertEquals("From: Kirjailijat line: 261", true, etsitty == tupu); 
    etsitty = kirjailijat.annaKirjailija(3); 
    assertEquals("From: Kirjailijat line: 263", true, etsitty == hupu); 
    etsitty = kirjailijat.annaKirjailija(4); 
    assertEquals("From: Kirjailijat line: 265", true, etsitty == lupu); 
    etsitty = kirjailijat.annaKirjailija(5); 
    assertEquals("From: Kirjailijat line: 267", true, etsitty == rupu); 
  } // Generated by ComTest END
}